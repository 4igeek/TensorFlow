...
1. [Non-Linear Binary Classification](https://github.com/4igeek/TensorFlow/blob/main/NonLinearBinaryClassification.ipynb) - A binary classification problem with non-linearity.
